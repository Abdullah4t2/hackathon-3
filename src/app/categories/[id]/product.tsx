            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {category.image && (
                    <div className="h-48 w-full overflow-hidden rounded-md mb-4 relative">
                      <Image
                        src={urlFor(category.image)} // Correct usage of urlFor for the image
                        alt={category.title}
          ...
          {products.map((product) => (
            ...
            >
              ...
              >
                ...
                {product.image && (
                  <div className="h-64 w-full overflow-hidden rounded-md mb-4 relative">
                    <Image
                      src={urlFor(product.image)} // Correct usage of urlFor for the image
                      alt={product.title}
                      layout="responsive" // Use layout responsive for better scaling
                      width={500} // Set base width
                      height={500} // Set base height
                      objectFit="cover" // Ensure the image covers the area without distortion
                      className="rounded-md"
                    />
                  </div>
